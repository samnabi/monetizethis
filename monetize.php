...
<main class="monet">
	...
	<p>Here it is &mdash; <a href="http://en.wikipedia.org/wiki/Claude_Monet" title="Claude Monet's Wikipedia page" target="_blank">monet</a>ized.</p>

	<p id="loading"><img src="img/load.gif" alt="Loading..."></p>

	<!-- First canvas is hidden by CSS -->
	<canvas id="canvas"></canvas>

	<!-- Second canvas shows the monet -->
	<canvas id="dest-canvas"></canvas>

	<p>Want to try again? <a href="/">Go back to the beginning</a>.</p>

	<script>
		// http://codepen.io/loktar00/pen/Fhzot
